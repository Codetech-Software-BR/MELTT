...
router.post("/vincular-plano", authMiddleware, turmaController.vincularPlanoFormatura);
router.delete("/desvincular-plano", authMiddleware, turmaController.desvincularPlanoFormatura);

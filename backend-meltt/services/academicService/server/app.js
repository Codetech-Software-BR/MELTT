...
app.get(
  "/api/alunos/turma/:id",
  authMiddleware,
  alunoController.getAlunosByTurmaId
);
...
app.get(
  "/api/faculdades/:id",
  authMiddleware,
  faculdadeController.getFaculdadeById
);
app.post(
  "/api/faculdades",
  authMiddleware,
  faculdadeController.createFaculdade
);
app.put(
  "/api/faculdades/:id",
  authMiddleware,
  faculdadeController.updateFaculdade
);
app.delete(
  "/api/faculdades/:id",
  authMiddleware,
  faculdadeController.deleteFaculdade
);
...
app.get(
  "/api/turmas/arquivos/turma/:id",
  authMiddleware,
  turmaController.getArquivosByTurmaId
);
app.get(
  "/api/turmas/arquivos/:id",
  authMiddleware,
  turmaController.getArquivoById
);
...
app.get(
  "/api/fornecedores/:id",
  authMiddleware,
  fornecedoresController.getFornecedoresById
);
app.post(
  "/api/fornecedores/",
  authMiddleware,
  fornecedoresController.createFornecedores
);
app.put(
  "/api/fornecedores/:id",
  authMiddleware,
  fornecedoresController.updateFornecedores
);
app.delete(
  "/api/fornecedores/:id",
  authMiddleware,
  fornecedoresController.deleteFornecedores
);
...
app.get(
  "/api/topicos/turma/:id",
  authMiddleware,
  topicosController.getTopicoByTurmaId
);
...
app.get(
  "/api/respostas/:id",
  authMiddleware,
  respostasController.getRespostaById
);
app.get(
  "/api/respostas/topico/:id",
  authMiddleware,
  respostasController.getRespostaByTopicoId
);
app.post("/api/respostas", authMiddleware, respostasController.createResposta);
app.patch(
  "/api/respostas/:id",
  authMiddleware,
  respostasController.updateResposta
);
app.delete(
  "/api/respostas/:id",
  authMiddleware,
  respostasController.deleteResposta
);
...
app.get(
  "/api/contratos/:id",
  authMiddleware,
  contratosController.getContratosById
);
app.get(
  "/api/contratos/associacao/:id",
  authMiddleware,
  contratosController.getContratosByAssociacaoId
);
app.post("/api/contratos", authMiddleware, contratosController.createContrato);
app.put(
  "/api/contratos/:id",
  authMiddleware,
  contratosController.updateContratos
);
app.delete(
  "/api/contratos/:id",
  authMiddleware,
  contratosController.deleteContratos
);

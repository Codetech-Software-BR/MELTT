...
exports.getAllRespostas = (req, res) => {
...
exports.getRespostaById = (req, res) => {
...
exports.getRespostaByTopicoId = (req, res) => {
  const id = req.params.id;
...
exports.updateResposta = (req, res) => {
  const id = req.params.id;
  const { topico_id, aluno_id, resposta } = req.body;
  const query =
...
exports.deleteResposta = (req, res) => {
  const id = req.params.id;

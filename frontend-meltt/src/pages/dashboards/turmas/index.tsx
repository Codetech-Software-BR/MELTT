...
const DashboardTurmasPage = () => {
  ...
  const [listTurmas, setListTurmas] = useState<any[]>([]);
      ...
      >
        ...
        {/* <TableCell align="left">
          <IconButton onClick={() => navigate("/atividades")}>
            <FiMoreVertical className="text-default" />
          </IconButton>
        </TableCell> */}
      </TableRow>
    );
  ...
  useEffect(() => {
    ...
    // );
    apiGetData("academic", `/turmas`).then((res) =>
      setListTurmas(res.slice(0, 5))
    );
...
export default DashboardTurmasPage;
